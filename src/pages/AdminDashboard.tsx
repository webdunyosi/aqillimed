...
import { FiSettings, FiUsers, FiGrid, FiLogOut } from 'react-icons/fi'
    ...
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        ...
        <div className="bg-slate-900 border border-white/10 rounded-2xl p-8 text-center text-slate-500">
          ...
          <Link
            to="/"
            className="inline-block mt-4 px-4 py-2 rounded-xl bg-cyan-500/10 text-cyan-400 border border-cyan-500/20 hover:bg-cyan-500/20 transition-colors text-sm"
          >
