...
import { FiHome, FiCalendar, FiUsers, FiMenu, FiX, FiLogOut } from 'react-icons/fi'
...
const navItems: NavItem[] = [
  { path: '/doctor', label: 'Doktor Paneli', icon: <FiHome /> },
  { path: '/doctor/appointments', label: 'Qabullar', icon: <FiCalendar /> },
  { path: '/doctor/patients', label: 'Bemorlar', icon: <FiUsers /> },
]
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <button
                ...
                className="mr-4 md:hidden text-slate-400 hover:text-slate-100 hover:bg-white/10 p-2 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-emerald-400/60"
                aria-label="Menyuni ochish"
              >
                <FiMenu className="text-xl" />
              </button>
              <Link to="/doctor" className="flex items-center gap-2.5 group">
                <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-emerald-400 to-teal-500 text-sm font-black text-slate-950 shadow-lg shadow-emerald-500/40 group-hover:scale-105 transition-transform duration-200">
                  +
                </span>
              ...
              return (
                <Link
                  ...
                  className={`
                    ...
                    ${isActive
                      ? 'bg-gradient-to-r from-emerald-500/20 to-teal-500/10 text-emerald-300 border border-emerald-500/30 shadow-lg shadow-emerald-500/10 scale-[1.02]'
