...
import { FiHome, FiCalendar, FiFileText, FiMenu, FiX, FiLogOut } from 'react-icons/fi'
...
const navItems: NavItem[] = [
  { path: '/patient', label: 'Shaxsiy Kabinet', icon: <FiHome /> },
  { path: '/patient/appointments', label: 'Mening qabullarim', icon: <FiCalendar /> },
  { path: '/patient/history', label: 'Tibbiy tarix', icon: <FiFileText /> },
]
          ...
          <div className="flex items-center justify-between h-16">
            <div className="flex items-center">
              <button
                ...
                className="mr-4 md:hidden text-slate-400 hover:text-slate-100 hover:bg-white/10 p-2 rounded-lg transition-all duration-200 focus:outline-none focus:ring-2 focus:ring-violet-400/60"
                aria-label="Menyuni ochish"
              >
                <FiMenu className="text-xl" />
              </button>
              <Link to="/patient" className="flex items-center gap-2.5 group">
                <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-violet-400 to-purple-500 text-sm font-black text-slate-950 shadow-lg shadow-violet-500/40 group-hover:scale-105 transition-transform duration-200">
                  +
                </span>
              ...
              return (
                <Link
                  ...
                  className={`
                    ...
                    ${isActive
                      ? 'bg-gradient-to-r from-violet-500/20 to-purple-500/10 text-violet-300 border border-violet-500/30 shadow-lg shadow-violet-500/10 scale-[1.02]'
